...
*   **Цель:** Настроить TLS так, чтобы поддерживались только современные, безопасные протоколы (TLSv1.2, TLSv1.3) и наборы шифров. Включить заголовок `HSTS` для защиты от атак понижения протокола.
